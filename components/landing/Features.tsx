...
export default function Features() {
    return (
        <section id="features" className="py-20 md:py-32 bg-surface/30">
            <div className="max-w-7xl mx-auto px-6">
                <div className="mb-12 md:mb-20">
                    <h2 className="text-3xl sm:text-4xl md:text-6xl font-black mb-6 tracking-tighter font-heading">The Engine Under <br /><span className="amethyst-gradient-text">The Hood.</span></h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div key={i} className="glass-card p-6 md:p-8 group hover:border-amethyst-500/30 transition-all">
                            ...
                            <h3 className="text-lg md:text-xl font-bold mb-3 font-heading">{feature.title}</h3>
